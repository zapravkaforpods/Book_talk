...
import Book3 from '../assets/Home/book3.svg';
        ...
        {Array.from({ length: 3 }).map((_, index) => (
          ...
          <View style={styles.historyContainer} key={index}>
            ...
            <View style={styles.searchItem}>
              ...
              />
              <View style={styles.bookInfo}>
                <Text style={styles.bookTitle}>Ангели в місячному світлі</Text>
                <Text style={styles.bookAuthor}>Кейм Макдоннелл</Text>
                <View style={styles.ratingContainer}>
                  <Feather name="star" size={16} color="#FFC107" />
                  <Text style={styles.ratingText}>4.5</Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  bookDescription: {
    fontSize: 12,
    color: '#191815',
    lineHeight: 16, // Збільшено для кращої читабельності
