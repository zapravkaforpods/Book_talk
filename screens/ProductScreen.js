    ...
    const initialDiscussions = [
      {
        ...
        title:
          "Доторк темряви: чи варта прочитання нова адаптація міфу про Гадеса і...",
      ...
      case "discussions":
        return (
          <Property
            ...
            stroke={activeCategory === "discussions" ? "white" : "black"}
            strokeWidth={0.5}
          />
        );
      case "drafts":
        return (
          <Correct
            style={styles.categoryIcon}
            stroke={activeCategory === "drafts" ? "white" : "black"}
            strokeWidth={0.5}
          />
        );
      case "liked":
        return (
          <Like
            style={styles.categoryIcon}
            stroke={activeCategory === "liked" ? "white" : "black"}
            strokeWidth={0.5}
          />
        );
      case "reposts":
        return (
          <Repost
            style={styles.categoryIcon}
            stroke={activeCategory === "reposts" ? "white" : "black"}
            strokeWidth={1}
          />
        );
      default:
        ...
        <View style={styles.profileInfo}>
          ...
          <View style={styles.statsContainer}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("UserDiscussions")}
            >
        ...
        <ScrollView horizontal style={styles.categories}>
          <TouchableOpacity
            style={[
              ...
              activeCategory === "discussions" && styles.activeCategoryButton,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.categoryText,
                activeCategory === "discussions" && styles.activeCategoryText,
              ]}
            >
              Обговорення
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.categoryButton,
              activeCategory === "drafts" && styles.activeCategoryButton,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.categoryText,
                activeCategory === "drafts" && styles.activeCategoryText,
              ]}
            >
              Чернетки
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.categoryButton,
              activeCategory === "liked" && styles.activeCategoryButton,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.categoryText,
                activeCategory === "liked" && styles.activeCategoryText,
              ]}
            >
              Лайкнуті
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.categoryButton,
              activeCategory === "reposts" && styles.activeCategoryButton,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.categoryText,
                activeCategory === "reposts" && styles.activeCategoryText,
              ]}
            >
              Репости
            </Text>
        ...
        {filteredDiscussions.map((item) => (
          <View key={item.id} style={styles.discussionCard}>
            ...
            <TouchableOpacity
              ...
              onPress={() => console.log("Лайкнути зверху")}
            >
              <Heart
