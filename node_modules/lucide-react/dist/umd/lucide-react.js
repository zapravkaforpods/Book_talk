...
(function (global, factory) {
  ...
  const AlignCenterHorizontal = createLucideIcon("align-center-horizontal", __iconNode$oG);
  ...
  const AlignHorizontalJustifyEnd = createLucideIcon("align-horizontal-justify-end", __iconNode$ow);
  ...
  const AlignHorizontalJustifyStart = createLucideIcon("align-horizontal-justify-start", __iconNode$ov);
  ...
  const AlignHorizontalSpaceAround = createLucideIcon("align-horizontal-space-around", __iconNode$ou);
  ...
  const AlignHorizontalSpaceBetween = createLucideIcon("align-horizontal-space-between", __iconNode$ot);
  ...
  const AlignJustify = createLucideIcon("align-justify", __iconNode$os);
  ...
  const AlignLeft = createLucideIcon("align-left", __iconNode$or);
  ...
  const AlignRight = createLucideIcon("align-right", __iconNode$oq);
  ...
  const AlignStartHorizontal = createLucideIcon("align-start-horizontal", __iconNode$op);
  ...
  const AlignStartVertical = createLucideIcon("align-start-vertical", __iconNode$oo);
  ...
  const AlignVerticalDistributeEnd = createLucideIcon("align-vertical-distribute-end", __iconNode$om);
  ...
  const AlignVerticalJustifyCenter = createLucideIcon("align-vertical-justify-center", __iconNode$ok);
  ...
  const AlignVerticalJustifyEnd = createLucideIcon("align-vertical-justify-end", __iconNode$oj);
  ...
  const AlignVerticalJustifyStart = createLucideIcon("align-vertical-justify-start", __iconNode$oi);
  ...
  const AlignVerticalSpaceAround = createLucideIcon("align-vertical-space-around", __iconNode$oh);
  ...
  const AlignVerticalSpaceBetween = createLucideIcon("align-vertical-space-between", __iconNode$og);
  ...
  const Ambulance = createLucideIcon("ambulance", __iconNode$of);
  ...
  const Ampersand = createLucideIcon("ampersand", __iconNode$oe);
  ...
  const Ampersands = createLucideIcon("ampersands", __iconNode$od);
  ...
  const Amphora = createLucideIcon("amphora", __iconNode$oc);
  ...
  const Anchor = createLucideIcon("anchor", __iconNode$ob);
  ...
  const Angry = createLucideIcon("angry", __iconNode$oa);
  ...
  const Annoyed = createLucideIcon("annoyed", __iconNode$o9);
  ...
  const Antenna = createLucideIcon("antenna", __iconNode$o8);
  ...
  const Anvil = createLucideIcon("anvil", __iconNode$o7);
  ...
  const Aperture = createLucideIcon("aperture", __iconNode$o6);
  ...
  const AppWindowMac = createLucideIcon("app-window-mac", __iconNode$o5);
  ...
  const AppWindow = createLucideIcon("app-window", __iconNode$o4);
  ...
  const Apple = createLucideIcon("apple", __iconNode$o3);
  ...
  const ArchiveRestore = createLucideIcon("archive-restore", __iconNode$o2);
  ...
  const ArchiveX = createLucideIcon("archive-x", __iconNode$o1);
  ...
  const Archive = createLucideIcon("archive", __iconNode$o0);
  ...
  const Armchair = createLucideIcon("armchair", __iconNode$n$);

  const __iconNode$n_ = [
    ["path", { d: "M15 5H9", key: "1tp3ed" }],
    ["path", { d: "M15 9v3h4l-7 7-7-7h4V9z", key: "ncdc4b" }]
  ];
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$n_);
  ...
  const ArrowRightToLine = createLucideIcon("arrow-right-to-line", __iconNode$nA);
  ...
  const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$nz);

  const __iconNode$ny = [
    ["path", { d: "M5 12h14", key: "1ays0h" }],
    ["path", { d: "m12 5 7 7-7 7", key: "xquz4c" }]
  ];
  const ArrowRight = createLucideIcon("arrow-right", __iconNode$ny);
  ...
  const ArrowUp01 = createLucideIcon("arrow-up-0-1", __iconNode$nx);
  ...
  const ArrowUp10 = createLucideIcon("arrow-up-1-0", __iconNode$nw);
  ...
  const ArrowUpAZ = createLucideIcon("arrow-up-a-z", __iconNode$nv);
  ...
  const ArrowUpDown = createLucideIcon("arrow-up-down", __iconNode$nu);
  ...
  const ArrowUpFromDot = createLucideIcon("arrow-up-from-dot", __iconNode$ns);

  const __iconNode$nr = [
    ["path", { d: "M7 17V7h10", key: "11bw93" }],
    ["path", { d: "M17 17 7 7", key: "2786uv" }]
  ];
  const ArrowUpLeft = createLucideIcon("arrow-up-left", __iconNode$nr);
  ...
  const ArrowUpNarrowWide = createLucideIcon("arrow-up-narrow-wide", __iconNode$nq);

  const __iconNode$np = [
    ["path", { d: "M7 7h10v10", key: "1tivn9" }],
    ["path", { d: "M7 17 17 7", key: "1vkiza" }]
  ];
  const ArrowUpRight = createLucideIcon("arrow-up-right", __iconNode$np);
  ...
  const ArrowUpToLine = createLucideIcon("arrow-up-to-line", __iconNode$no);
  ...
  const ArrowUpWideNarrow = createLucideIcon("arrow-up-wide-narrow", __iconNode$nn);
  ...
  const ArrowUp = createLucideIcon("arrow-up", __iconNode$nl);
  ...
  const ArrowsUpFromLine = createLucideIcon("arrows-up-from-line", __iconNode$nk);
  ...
  const Asterisk = createLucideIcon("asterisk", __iconNode$nj);

  const __iconNode$ni = [
    ["circle", { cx: "12", cy: "12", r: "4", key: "4exip2" }],
    ["path", { d: "M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-4 8", key: "7n84p3" }]
  ];
  const AtSign = createLucideIcon("at-sign", __iconNode$ni);
  ...
  const Atom = createLucideIcon("atom", __iconNode$nh);
  ...
  const AudioLines = createLucideIcon("audio-lines", __iconNode$ng);
  ...
  const AudioWaveform = createLucideIcon("audio-waveform", __iconNode$nf);
  ...
  const Award = createLucideIcon("award", __iconNode$ne);
  ...
  const Axe = createLucideIcon("axe", __iconNode$nd);

  const __iconNode$nc = [
    ["path", { d: "M4 4v16h16", key: "1s015l" }],
    ["path", { d: "m4 20 7-7", key: "17qe9y" }]
  ];
  const Axis3d = createLucideIcon("axis-3d", __iconNode$nc);
  ...
  const Baby = createLucideIcon("baby", __iconNode$nb);
  ...
  const Backpack = createLucideIcon("backpack", __iconNode$na);
  ...
  const BadgeAlert = createLucideIcon("badge-alert", __iconNode$n9);
  ...
  const BadgeCent = createLucideIcon("badge-cent", __iconNode$n8);
  ...
  const BadgeCheck = createLucideIcon("badge-check", __iconNode$n7);
  ...
  const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$n6);
  ...
  const BadgeEuro = createLucideIcon("badge-euro", __iconNode$n5);
  ...
  const BadgeHelp = createLucideIcon("badge-help", __iconNode$n4);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$n3);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$n2);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$n1);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$n0);
  ...
  const BadgePercent = createLucideIcon("badge-percent", __iconNode$m$);
  ...
  const BadgePlus = createLucideIcon("badge-plus", __iconNode$m_);
  ...
  const BellMinus = createLucideIcon("bell-minus", __iconNode$mr);
  ...
  const Bell = createLucideIcon("bell", __iconNode$mn);
  ...
  const BetweenHorizontalEnd = createLucideIcon("between-horizontal-end", __iconNode$mm);
  ...
  const BetweenHorizontalStart = createLucideIcon("between-horizontal-start", __iconNode$ml);
  ...
  const BetweenVerticalEnd = createLucideIcon("between-vertical-end", __iconNode$mk);
  ...
  const BetweenVerticalStart = createLucideIcon("between-vertical-start", __iconNode$mj);
  ...
  const BicepsFlexed = createLucideIcon("biceps-flexed", __iconNode$mi);
  ...
  const Bike = createLucideIcon("bike", __iconNode$mh);
  ...
  const Binary = createLucideIcon("binary", __iconNode$mg);
  ...
  const Binoculars = createLucideIcon("binoculars", __iconNode$mf);
  ...
  const Biohazard = createLucideIcon("biohazard", __iconNode$me);
  ...
  const Bird = createLucideIcon("bird", __iconNode$md);

  const __iconNode$mc = [
    ["circle", { cx: "9", cy: "9", r: "7", key: "p2h5vp" }],
    ["circle", { cx: "15", cy: "15", r: "7", key: "19ennj" }]
  ];
  const Blend = createLucideIcon("blend", __iconNode$mc);
  ...
  const Bitcoin = createLucideIcon("bitcoin", __iconNode$mb);
  ...
  const BookA = createLucideIcon("book-a", __iconNode$m0);
  ...
  const BookAudio = createLucideIcon("book-audio", __iconNode$l$);
  ...
  const BookCheck = createLucideIcon("book-check", __iconNode$l_);
  ...
  const BookUser = createLucideIcon("book-user", __iconNode$lI);
  ...
  const BookmarkMinus = createLucideIcon("bookmark-minus", __iconNode$lE);

  const __iconNode$lD = [
    ["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z", key: "169p4p" }],
    ["path", { d: "m9 10 2 2 4-4", key: "1gnqz4" }]
  ];
  const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$lD);
  ...
  const Bot = createLucideIcon("bot", __iconNode$lw);
  ...
  const BrickWall = createLucideIcon("brick-wall", __iconNode$lm);
  ...
  const BriefcaseMedical = createLucideIcon("briefcase-medical", __iconNode$lj);

  const __iconNode$li = [
    ["path", { d: "M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16", key: "jecpp" }],
    ["rect", { width: "20", height: "14", x: "2", y: "6", rx: "2", key: "i6l2r4" }]
  ];
  const Briefcase = createLucideIcon("briefcase", __iconNode$li);
  ...
  const BringToFront = createLucideIcon("bring-to-front", __iconNode$lh);
  ...
  const BrushCleaning = createLucideIcon("brush-cleaning", __iconNode$lg);
  ...
  const BugOff = createLucideIcon("bug-off", __iconNode$ld);
  ...
  const BugPlay = createLucideIcon("bug-play", __iconNode$lc);
  ...
  const Bug = createLucideIcon("bug", __iconNode$lb);
  ...
  const Building = createLucideIcon("building", __iconNode$la);
  ...
  const Building2 = createLucideIcon("building-2", __iconNode$l9);
  ...
  const CalendarDays = createLucideIcon("calendar-days", __iconNode$kX);
  ...
  const CalendarCog = createLucideIcon("calendar-cog", __iconNode$kW);
  ...
  const CameraOff = createLucideIcon("camera-off", __iconNode$kI);
  ...
  const Camera = createLucideIcon("camera", __iconNode$kH);
  ...
  const CandyCane = createLucideIcon("candy-cane", __iconNode$kG);
  ...
  const CandyOff = createLucideIcon("candy-off", __iconNode$kF);
  ...
  const Candy = createLucideIcon("candy", __iconNode$kE);
  ...
  const Captions = createLucideIcon("captions", __iconNode$kB);
  ...
  const CarFront = createLucideIcon("car-front", __iconNode$kA);
  ...
  const CarTaxiFront = createLucideIcon("car-taxi-front", __iconNode$kz);
  ...
  const Car = createLucideIcon("car", __iconNode$ky);
  ...
  const Caravan = createLucideIcon("caravan", __iconNode$kx);
  ...
  const Cast = createLucideIcon("cast", __iconNode$kr);
  ...
  const Castle = createLucideIcon("castle", __iconNode$kq);
  ...
  const ChartColumn = createLucideIcon("chart-column", __iconNode$kc);
  ...
  const ChartGantt = createLucideIcon("chart-gantt", __iconNode$kb);

  const __iconNode$ka = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "m19 9-5 5-4-4-3 3", key: "2osh9i" }]
  ];
  const ChartLine = createLucideIcon("chart-line", __iconNode$ka);
  ...
  const ChartNetwork = createLucideIcon("chart-network", __iconNode$k9);
  ...
  const ChartNoAxesColumnDecreasing = createLucideIcon("chart-no-axes-column-decreasing", __iconNode$k8);
  ...
  const ChartNoAxesColumnIncreasing = createLucideIcon("chart-no-axes-column-increasing", __iconNode$k7);
  ...
  const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$k6);
  ...
  const ChartNoAxesCombined = createLucideIcon("chart-no-axes-combined", __iconNode$k5);
  ...
  const ChartScatter = createLucideIcon("chart-scatter", __iconNode$k2);

  const __iconNode$k1 = [
    ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
    ["path", { d: "M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7", key: "lw07rv" }]
  ];
  const ChartSpline = createLucideIcon("chart-spline", __iconNode$k1);

  const __iconNode$k0 = [
    ["path", { d: "M18 6 7 17l-5-5", key: "116fxf" }],
    ["path", { d: "m22 10-7.5 7.5L13 16", key: "ke71qq" }]
  ];
  const CheckCheck = createLucideIcon("check-check", __iconNode$k0);
  ...
  const __iconNode$jY = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]];
  const ChevronDown = createLucideIcon("chevron-down", __iconNode$jY);

  const __iconNode$jX = [
    ["path", { d: "m17 18-6-6 6-6", key: "1yerx2" }],
    ["path", { d: "M7 6v12", key: "1p53r6" }]
  ];
  const ChevronFirst = createLucideIcon("chevron-first", __iconNode$jX);

  const __iconNode$jW = [
    ["path", { d: "m7 18 6-6-6-6", key: "lwmzdw" }],
    ["path", { d: "M17 6v12", key: "1o0aio" }]
  ];
  const ChevronLast = createLucideIcon("chevron-last", __iconNode$jW);

  const __iconNode$jV = [["path", { d: "m15 18-6-6 6-6", key: "1wnfg3" }]];
  const ChevronLeft = createLucideIcon("chevron-left", __iconNode$jV);

  const __iconNode$jU = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]];
  const ChevronRight = createLucideIcon("chevron-right", __iconNode$jU);

  const __iconNode$jT = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]];
  const ChevronUp = createLucideIcon("chevron-up", __iconNode$jT);
  ...
  const ChevronsLeft = createLucideIcon("chevrons-left", __iconNode$jO);
  ...
  const ChevronsUpDown = createLucideIcon("chevrons-up-down", __iconNode$jL);

  const __iconNode$jK = [
    ["path", { d: "m17 11-5-5-5 5", key: "e8nh98" }],
    ["path", { d: "m17 18-5-5-5 5", key: "2avn1x" }]
  ];
  const ChevronsUp = createLucideIcon("chevrons-up", __iconNode$jK);
  ...
  const Chrome = createLucideIcon("chrome", __iconNode$jJ);
  ...
  const Church = createLucideIcon("church", __iconNode$jI);
  ...
  const CigaretteOff = createLucideIcon("cigarette-off", __iconNode$jH);
  ...
  const CircleAlert = createLucideIcon("circle-alert", __iconNode$jF);
  ...
  const CircleArrowOutUpLeft = createLucideIcon("circle-arrow-out-up-left", __iconNode$jz);
  ...
  const CircleCheck = createLucideIcon("circle-check", __iconNode$jv);

  const __iconNode$ju = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m16 10-4 4-4-4", key: "894hmk" }]
  ];
  const CircleChevronDown = createLucideIcon("circle-chevron-down", __iconNode$ju);

  const __iconNode$jt = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m14 16-4-4 4-4", key: "ojs7w8" }]
  ];
  const CircleChevronLeft = createLucideIcon("circle-chevron-left", __iconNode$jt);

  const __iconNode$js = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m10 8 4 4-4 4", key: "1wy4r4" }]
  ];
  const CircleChevronRight = createLucideIcon("circle-chevron-right", __iconNode$js);

  const __iconNode$jr = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m8 14 4-4 4 4", key: "fy2ptz" }]
  ];
  const CircleChevronUp = createLucideIcon("circle-chevron-up", __iconNode$jr);
  ...
  const CircleDashed = createLucideIcon("circle-dashed", __iconNode$jo);
  ...
  const CircleDotDashed = createLucideIcon("circle-dot-dashed", __iconNode$jn);

  const __iconNode$jm = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["circle", { cx: "12", cy: "12", r: "1", key: "41hilf" }]
  ];
  const CircleDot = createLucideIcon("circle-dot", __iconNode$jm);
  ...
  const CircleEllipsis = createLucideIcon("circle-ellipsis", __iconNode$jl);
  ...
  const CircleEqual = createLucideIcon("circle-equal", __iconNode$jk);
  ...
  const CircleFadingArrowUp = createLucideIcon("circle-fading-arrow-up", __iconNode$jj);
  ...
  const CircleFadingPlus = createLucideIcon("circle-fading-plus", __iconNode$ji);
  ...
  const CircleGauge = createLucideIcon("circle-gauge", __iconNode$jh);
  ...
  const CircleHelp = createLucideIcon("circle-help", __iconNode$jg);

  const __iconNode$jf = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M8 12h8", key: "1wcyev" }]
  ];
  const CircleMinus = createLucideIcon("circle-minus", __iconNode$jf);
  ...
  const CircleOff = createLucideIcon("circle-off", __iconNode$je);
  ...
  const CircleParkingOff = createLucideIcon("circle-parking-off", __iconNode$jd);

  const __iconNode$jc = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M9 17V7h4a3 3 0 0 1 0 6H9", key: "1dfk2c" }]
  ];
  const CircleParking = createLucideIcon("circle-parking", __iconNode$jc);
  ...
  const CirclePause = createLucideIcon("circle-pause", __iconNode$jb);
  ...
  const CirclePercent = createLucideIcon("circle-percent", __iconNode$ja);

  const __iconNode$j9 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polygon", { points: "10 8 16 12 10 16 10 8", key: "1cimsy" }]
  ];
  const CirclePlay = createLucideIcon("circle-play", __iconNode$j9);
  ...
  const CirclePlus = createLucideIcon("circle-plus", __iconNode$j8);
  ...
  const CirclePower = createLucideIcon("circle-power", __iconNode$j7);
  ...
  const CircleStop = createLucideIcon("circle-stop", __iconNode$j3);
  ...
  const CircleUserRound = createLucideIcon("circle-user-round", __iconNode$j2);
  ...
  const CircleUser = createLucideIcon("circle-user", __iconNode$j1);
  ...
  const CircuitBoard = createLucideIcon("circuit-board", __iconNode$i_);
  ...
  const Citrus = createLucideIcon("citrus", __iconNode$iZ);
  ...
  const Clapperboard = createLucideIcon("clapperboard", __iconNode$iY);
  ...
  const ClipboardCheck = createLucideIcon("clipboard-check", __iconNode$iX);
  ...
  const ClockAlert = createLucideIcon("clock-alert", __iconNode$iA);
  ...
  const ClockArrowDown = createLucideIcon("clock-arrow-down", __iconNode$iz);
  ...
  const ClockFading = createLucideIcon("clock-fading", __iconNode$ix);
  ...
  const Clock = createLucideIcon("clock", __iconNode$iv);
  ...
  const CloudAlert = createLucideIcon("cloud-alert", __iconNode$iu);
  ...
  const Code = createLucideIcon("code", __iconNode$i9);
  ...
  const Codepen = createLucideIcon("codepen", __iconNode$i8);
  ...
  const Codesandbox = createLucideIcon("codesandbox", __iconNode$i7);
  ...
  const Coffee = createLucideIcon("coffee", __iconNode$i6);
  ...
  const Cog = createLucideIcon("cog", __iconNode$i5);
  ...
  const Coins = createLucideIcon("coins", __iconNode$i4);

  const __iconNode$i3 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M12 3v18", key: "108xh3" }]
  ];
  const Columns2 = createLucideIcon("columns-2", __iconNode$i3);
  ...
  const Columns3Cog = createLucideIcon("columns-3-cog", __iconNode$i2);
  ...
  const Columns3 = createLucideIcon("columns-3", __iconNode$i1);
  ...
  const Columns4 = createLucideIcon("columns-4", __iconNode$i0);
  ...
  const Combine = createLucideIcon("combine", __iconNode$h$);
  ...
  const Command = createLucideIcon("command", __iconNode$h_);
  ...
  const Compass = createLucideIcon("compass", __iconNode$hZ);
  ...
  const Component = createLucideIcon("component", __iconNode$hY);
  ...
  const Computer = createLucideIcon("computer", __iconNode$hX);
  ...
  const ConciergeBell = createLucideIcon("concierge-bell", __iconNode$hW);

  const __iconNode$hV = [
    ["path", { d: "m20.9 18.55-8-15.98a1 1 0 0 0-1.8 0l-8 15.98", key: "53pte7" }],
    ["ellipse", { cx: "12", cy: "19", rx: "9", ry: "3", key: "1ji25f" }]
  ];
  const Cone = createLucideIcon("cone", __iconNode$hV);
  ...
  const Construction = createLucideIcon("construction", __iconNode$hU);
  ...
  const ContactRound = createLucideIcon("contact-round", __iconNode$hT);
  ...
  const Container = createLucideIcon("container", __iconNode$hR);

  const __iconNode$hQ = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 18a6 6 0 0 0 0-12v12z", key: "j4l70d" }]
  ];
  const Contrast = createLucideIcon("contrast", __iconNode$hQ);
  ...
  const Cookie = createLucideIcon("cookie", __iconNode$hP);
  ...
  const CookingPot = createLucideIcon("cooking-pot", __iconNode$hO);
  ...
  const CopyCheck = createLucideIcon("copy-check", __iconNode$hN);
  ...
  const CopyMinus = createLucideIcon("copy-minus", __iconNode$hM);
  ...
  const CopyX = createLucideIcon("copy-x", __iconNode$hJ);

  const __iconNode$hI = [
    ["rect", { width: "14", height: "14", x: "8", y: "8", rx: "2", ry: "2", key: "17jyea" }],
    ["path", { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2", key: "zix9uf" }]
  ];
  const Copy = createLucideIcon("copy", __iconNode$hI);
  ...
  const CornerDownLeft = createLucideIcon("corner-down-left", __iconNode$hE);
  ...
  const CreativeCommons = createLucideIcon("creative-commons", __iconNode$hv);
  ...
  const Diamond = createLucideIcon("diamond", __iconNode$h9);

  const __iconNode$h8 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", ry: "2", key: "1m3agn" }],
    ["path", { d: "M12 12h.01", key: "1mp3jc" }]
  ];
  const Dice1 = createLucideIcon("dice-1", __iconNode$h8);
  ...
  const Dice3 = createLucideIcon("dice-3", __iconNode$h6);
  ...
  const Dice4 = createLucideIcon("dice-4", __iconNode$h5);
  ...
  const Dice5 = createLucideIcon("dice-5", __iconNode$h4);
  ...
  const Dice6 = createLucideIcon("dice-6", __iconNode$h3);
  ...
  const Dices = createLucideIcon("dices", __iconNode$h2);
  ...
  const Diff = createLucideIcon("diff", __iconNode$h1);
  ...
  const Disc2 = createLucideIcon("disc-2", __iconNode$h0);
  ...
  const Disc3 = createLucideIcon("disc-3", __iconNode$g$);
  ...
  const DiscAlbum = createLucideIcon("disc-album", __iconNode$g_);

  const __iconNode$gZ = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["circle", { cx: "12", cy: "12", r: "2", key: "1c9p78" }]
  ];
  const Disc = createLucideIcon("disc", __iconNode$gZ);
  ...
  const Divide = createLucideIcon("divide", __iconNode$gY);
  ...
  const DnaOff = createLucideIcon("dna-off", __iconNode$gX);
  ...
  const Dna = createLucideIcon("dna", __iconNode$gW);
  ...
  const Dock = createLucideIcon("dock", __iconNode$gV);
  ...
  const Dog = createLucideIcon("dog", __iconNode$gU);

  const __iconNode$gT = [
    ["line", { x1: "12", x2: "12", y1: "2", y2: "22", key: "7eqyqh" }],
    ["path", { d: "M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6", key: "1b0p4s" }]
  ];
  const DollarSign = createLucideIcon("dollar-sign", __iconNode$gT);
  ...
  const DoorClosedLocked = createLucideIcon("door-closed-locked", __iconNode$gR);
  ...
  const DoorClosed = createLucideIcon("door-closed", __iconNode$gQ);
  ...
  const DoorOpen = createLucideIcon("door-open", __iconNode$gP);

  const __iconNode$gO = [["circle", { cx: "12.1", cy: "12.1", r: "1", key: "18d7e5" }]];
  const Dot = createLucideIcon("dot", __iconNode$gO);
  ...
  const Download = createLucideIcon("download", __iconNode$gN);
  ...
  const DraftingCompass = createLucideIcon("drafting-compass", __iconNode$gM);
  ...
  const Dribbble = createLucideIcon("dribbble", __iconNode$gK);
  ...
  const Drill = createLucideIcon("drill", __iconNode$gJ);
  ...
  const DropletOff = createLucideIcon("droplet-off", __iconNode$gI);
  ...
  const Droplet = createLucideIcon("droplet", __iconNode$gG);
  ...
  const Drumstick = createLucideIcon("drumstick", __iconNode$gE);
  ...
  const Dumbbell = createLucideIcon("dumbbell", __iconNode$gD);
  ...
  const EarOff = createLucideIcon("ear-off", __iconNode$gC);
  ...
  const EarthLock = createLucideIcon("earth-lock", __iconNode$gA);
  ...
  const Earth = createLucideIcon("earth", __iconNode$gz);

  const __iconNode$gy = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "M12 2a7 7 0 1 0 10 10", key: "1yuj32" }]
  ];
  const Eclipse = createLucideIcon("eclipse", __iconNode$gy);
  ...
  const EggOff = createLucideIcon("egg-off", __iconNode$gw);
  ...
  const EllipsisVertical = createLucideIcon("ellipsis-vertical", __iconNode$gu);
  ...
  const Ellipsis = createLucideIcon("ellipsis", __iconNode$gt);

  const __iconNode$gs = [
    ["path", { d: "M5 15a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0", key: "yrdkhy" }],
    ["path", { d: "M5 9a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0", key: "gzkvyz" }]
  ];
  const EqualApproximately = createLucideIcon("equal-approximately", __iconNode$gs);
  ...
  const EqualNot = createLucideIcon("equal-not", __iconNode$gr);

  const __iconNode$gq = [
    ["line", { x1: "5", x2: "19", y1: "9", y2: "9", key: "1nwqeh" }],
    ["line", { x1: "5", x2: "19", y1: "15", y2: "15", key: "g8yjpy" }]
  ];
  const Equal = createLucideIcon("equal", __iconNode$gq);
  ...
  const Eraser = createLucideIcon("eraser", __iconNode$gp);
  ...
  const EthernetPort = createLucideIcon("ethernet-port", __iconNode$go);
  ...
  const ExternalLink = createLucideIcon("external-link", __iconNode$gl);
  ...
  const EyeClosed = createLucideIcon("eye-closed", __iconNode$gk);
  ...
  const EyeOff = createLucideIcon("eye-off", __iconNode$gj);
  ...
  const Eye = createLucideIcon("eye", __iconNode$gi);
  ...
  const Facebook = createLucideIcon("facebook", __iconNode$gh);
  ...
  const Fan = createLucideIcon("fan", __iconNode$gf);

  const __iconNode$ge = [
    ["polygon", { points: "13 19 22 12 13 5 13 19", key: "587y9g" }],
    ["polygon", { points: "2 19 11 12 2 5 2 19", key: "3pweh0" }]
  ];
  const FastForward = createLucideIcon("fast-forward", __iconNode$ge);
  ...
  const Feather = createLucideIcon("feather", __iconNode$gd);
  ...
  const Fence = createLucideIcon("fence", __iconNode$gc);
  ...
  const FerrisWheel = createLucideIcon("ferris-wheel", __iconNode$gb);
  ...
  const Figma = createLucideIcon("figma", __iconNode$ga);
  ...
  const FileArchive = createLucideIcon("file-archive", __iconNode$g9);
  ...
  const FileAudio2 = createLucideIcon("file-audio-2", __iconNode$g8);
  ...
  const FileAudio = createLucideIcon("file-audio", __iconNode$g7);
  ...
  const FileAxis3d = createLucideIcon("file-axis-3d", __iconNode$g6);
  ...
  const FileBadge2 = createLucideIcon("file-badge-2", __iconNode$g5);
  ...
  const FileBadge = createLucideIcon("file-badge", __iconNode$g4);
  ...
  const FileBox = createLucideIcon("file-box", __iconNode$g3);
  ...
  const FileChartColumnIncreasing = createLucideIcon("file-chart-column-increasing", __iconNode$g2);
  ...
  const FileChartColumn = createLucideIcon("file-chart-column", __iconNode$g1);
  ...
  const FileChartLine = createLucideIcon("file-chart-line", __iconNode$g0);
  ...
  const FileChartPie = createLucideIcon("file-chart-pie", __iconNode$f$);
  ...
  const FileCheck2 = createLucideIcon("file-check-2", __iconNode$f_);
  ...
  const FileCheck = createLucideIcon("file-check", __iconNode$fZ);
  ...
  const FileClock = createLucideIcon("file-clock", __iconNode$fY);
  ...
  const FileCode2 = createLucideIcon("file-code-2", __iconNode$fX);
  ...
  const FileCode = createLucideIcon("file-code", __iconNode$fW);
  ...
  const FileCog = createLucideIcon("file-cog", __iconNode$fV);
  ...
  const FileDiff = createLucideIcon("file-diff", __iconNode$fU);
  ...
  const FileDigit = createLucideIcon("file-digit", __iconNode$fT);
  ...
  const FileDown = createLucideIcon("file-down", __iconNode$fR);
  ...
  const FileImage = createLucideIcon("file-image", __iconNode$fQ);
  ...
  const FileInput = createLucideIcon("file-input", __iconNode$fP);
  ...
  const FileJson2 = createLucideIcon("file-json-2", __iconNode$fO);
  ...
  const FileJson = createLucideIcon("file-json", __iconNode$fN);
  ...
  const FileKey2 = createLucideIcon("file-key-2", __iconNode$fM);
  ...
  const FileKey = createLucideIcon("file-key", __iconNode$fL);
  ...
  const FileLock2 = createLucideIcon("file-lock-2", __iconNode$fK);
  ...
  const FileLock = createLucideIcon("file-lock", __iconNode$fJ);
  ...
  const FileMinus = createLucideIcon("file-minus", __iconNode$fH);
  ...
  const FileMusic = createLucideIcon("file-music", __iconNode$fG);
  ...
  const FileOutput = createLucideIcon("file-output", __iconNode$fF);
  ...
  const FilePenLine = createLucideIcon("file-pen-line", __iconNode$fE);
  ...
  const FilePen = createLucideIcon("file-pen", __iconNode$fD);
  ...
  const FilePlus2 = createLucideIcon("file-plus-2", __iconNode$fC);
  ...
  const FileSpreadsheet = createLucideIcon("file-spreadsheet", __iconNode$fv);
  ...
  const FileStack = createLucideIcon("file-stack", __iconNode$fu);
  ...
  const FileSymlink = createLucideIcon("file-symlink", __iconNode$ft);
  ...
  const FileTerminal = createLucideIcon("file-terminal", __iconNode$fs);
  ...
  const FileText = createLucideIcon("file-text", __iconNode$fr);
  ...
  const FileType2 = createLucideIcon("file-type-2", __iconNode$fq);
  ...
  const FileType = createLucideIcon("file-type", __iconNode$fp);
  ...
  const FileUp = createLucideIcon("file-up", __iconNode$fo);
  ...
  const FileUser = createLucideIcon("file-user", __iconNode$fn);
  ...
  const FileVideo2 = createLucideIcon("file-video-2", __iconNode$fm);
  ...
  const FileVideo = createLucideIcon("file-video", __iconNode$fl);
  ...
  const FileVolume2 = createLucideIcon("file-volume-2", __iconNode$fk);
  ...
  const FileVolume = createLucideIcon("file-volume", __iconNode$fj);
  ...
  const FileWarning = createLucideIcon("file-warning", __iconNode$fi);
  ...
  const FileX2 = createLucideIcon("file-x-2", __iconNode$fh);
  ...
  const FileX = createLucideIcon("file-x", __iconNode$fg);

  const __iconNode$ff = [
    ["path", { d: "M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z", key: "1rqfz7" }],
    ["path", { d: "M14 2v4a2 2 0 0 0 2 2h4", key: "tnqrlb" }]
  ];
  const File = createLucideIcon("file", __iconNode$ff);
  ...
  const Files = createLucideIcon("files", __iconNode$fe);
  ...
  const FishOff = createLucideIcon("fish-off", __iconNode$fa);

  const __iconNode$f9 = [
    ["path", { d: "M2 16s9-15 20-4C11 23 2 8 2 8", key: "h4oh4o" }]
  ];
  const FishSymbol = createLucideIcon("fish-symbol", __iconNode$f9);
  ...
  const Fish = createLucideIcon("fish", __iconNode$f8);
  ...
  const FlagOff = createLucideIcon("flag-off", __iconNode$f7);

  const __iconNode$f6 = [["path", { d: "M17 22V2L7 7l10 5", key: "1rmf0r" }]];
  const FlagTriangleLeft = createLucideIcon("flag-triangle-left", __iconNode$f6);

  const __iconNode$f5 = [["path", { d: "M7 22V2l10 5-10 5", key: "17n18y" }]];
  const FlagTriangleRight = createLucideIcon("flag-triangle-right", __iconNode$f5);

  const __iconNode$f4 = [
    ["path", { d: "M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z", key: "i9b6wo" }],
    ["line", { x1: "4", x2: "4", y1: "22", y2: "15", key: "1cm3nv" }]
  ];
  const Flag = createLucideIcon("flag", __iconNode$f4);
  ...
  const FlameKindling = createLucideIcon("flame-kindling", __iconNode$f3);
  ...
  const Flame = createLucideIcon("flame", __iconNode$f2);
  ...
  const FlashlightOff = createLucideIcon("flashlight-off", __iconNode$f1);
  ...
  const Flashlight = createLucideIcon("flashlight", __iconNode$f0);
  ...
  const FlaskConicalOff = createLucideIcon("flask-conical-off", __iconNode$e_);
  ...
  const FlaskRound = createLucideIcon("flask-round", __iconNode$eZ);
  ...
  const FlipHorizontal2 = createLucideIcon("flip-horizontal-2", __iconNode$eY);
  ...
  const FlipHorizontal = createLucideIcon("flip-horizontal", __iconNode$eX);
  ...
  const FlipVertical2 = createLucideIcon("flip-vertical-2", __iconNode$eW);
  ...
  const FlipVertical = createLucideIcon("flip-vertical", __iconNode$eV);
  ...
  const Flower2 = createLucideIcon("flower-2", __iconNode$eU);
  ...
  const Flower = createLucideIcon("flower", __iconNode$eT);
  ...
  const Focus = createLucideIcon("focus", __iconNode$eS);
  ...
  const FoldHorizontal = createLucideIcon("fold-horizontal", __iconNode$eR);
  ...
  const FoldVertical = createLucideIcon("fold-vertical", __iconNode$eQ);
  ...
  const FolderCheck = createLucideIcon("folder-check", __iconNode$eO);
  ...
  const FolderClock = createLucideIcon("folder-clock", __iconNode$eN);
  ...
  const FolderClosed = createLucideIcon("folder-closed", __iconNode$eM);
  ...
  const FolderCode = createLucideIcon("folder-code", __iconNode$eL);
  ...
  const FolderCog = createLucideIcon("folder-cog", __iconNode$eK);
  ...
  const FolderDot = createLucideIcon("folder-dot", __iconNode$eI);
  ...
  const FolderGit2 = createLucideIcon("folder-git-2", __iconNode$eH);
  ...
  const FolderGit = createLucideIcon("folder-git", __iconNode$eG);
  ...
  const FolderHeart = createLucideIcon("folder-heart", __iconNode$eF);
  ...
  const FolderKanban = createLucideIcon("folder-kanban", __iconNode$eD);
  ...
  const FolderKey = createLucideIcon("folder-key", __iconNode$eC);
  ...
  const FolderLock = createLucideIcon("folder-lock", __iconNode$eB);
  ...
  const FolderOpenDot = createLucideIcon("folder-open-dot", __iconNode$ez);
  ...
  const FolderOutput = createLucideIcon("folder-output", __iconNode$ex);
  ...
  const FolderPen = createLucideIcon("folder-pen", __iconNode$ew);
  ...
  const FolderPlus = createLucideIcon("folder-plus", __iconNode$ev);
  ...
  const FolderRoot = createLucideIcon("folder-root", __iconNode$eu);
  ...
  const FolderSymlink = createLucideIcon("folder-symlink", __iconNode$er);
  ...
  const FolderTree = createLucideIcon("folder-tree", __iconNode$ep);
  ...
  const Folder = createLucideIcon("folder", __iconNode$em);
  ...
  const Folders = createLucideIcon("folders", __iconNode$el);
  ...
  const Footprints = createLucideIcon("footprints", __iconNode$ek);
  ...
  const Forklift = createLucideIcon("forklift", __iconNode$ej);

  const __iconNode$ei = [
    ["polyline", { points: "15 17 20 12 15 7", key: "1w3sku" }],
    ["path", { d: "M4 18v-2a4 4 0 0 1 4-4h12", key: "jmiej9" }]
  ];
  const Forward = createLucideIcon("forward", __iconNode$ei);
  ...
  const Frame = createLucideIcon("frame", __iconNode$eh);

  const __iconNode$eg = [
    ["path", { d: "M5 16V9h14V2H5l14 14h-7m-7 0 7 7v-7m-7 0h7", key: "1a2nng" }]
  ];
  const Framer = createLucideIcon("framer", __iconNode$eg);
  ...
  const Fuel = createLucideIcon("fuel", __iconNode$ee);
  ...
  const Fullscreen = createLucideIcon("fullscreen", __iconNode$ed);
  ...
  const FunnelPlus = createLucideIcon("funnel-plus", __iconNode$ec);
  ...
  const Funnel = createLucideIcon("funnel", __iconNode$ea);
  ...
  const GalleryHorizontalEnd = createLucideIcon("gallery-horizontal-end", __iconNode$e9);
  ...
  const GalleryThumbnails = createLucideIcon("gallery-thumbnails", __iconNode$e8);
  ...
  const GalleryHorizontal = createLucideIcon("gallery-horizontal", __iconNode$e7);
  ...
  const GalleryVerticalEnd = createLucideIcon("gallery-vertical-end", __iconNode$e6);
  ...
  const GalleryVertical = createLucideIcon("gallery-vertical", __iconNode$e5);
  ...
  const Gamepad2 = createLucideIcon("gamepad-2", __iconNode$e4);
  ...
  const Gamepad = createLucideIcon("gamepad", __iconNode$e3);

  const __iconNode$e2 = [
    ["path", { d: "m12 14 4-4", key: "9kzdfg" }],
    ["path", { d: "M3.34 19a10 10 0 1 1 17.32 0", key: "19p75a" }]
  ];
  const Gauge = createLucideIcon("gauge", __iconNode$e2);
  ...
  const Gavel = createLucideIcon("gavel", __iconNode$e1);
  ...
  const Gem = createLucideIcon("gem", __iconNode$e0);
  ...
  const Ghost = createLucideIcon("ghost", __iconNode$d$);
  ...
  const Gift = createLucideIcon("gift", __iconNode$d_);
  ...
  const GitBranchPlus = createLucideIcon("git-branch-plus", __iconNode$dZ);
  ...
  const GitBranch = createLucideIcon("git-branch", __iconNode$dY);
  ...
  const GitCommitHorizontal = createLucideIcon("git-commit-horizontal", __iconNode$dX);
  ...
  const GitCommitVertical = createLucideIcon("git-commit-vertical", __iconNode$dW);
  ...
  const GitCompareArrows = createLucideIcon("git-compare-arrows", __iconNode$dV);
  ...
  const GitCompare = createLucideIcon("git-compare", __iconNode$dU);
  ...
  const GitFork = createLucideIcon("git-fork", __iconNode$dT);
  ...
  const GitGraph = createLucideIcon("git-graph", __iconNode$dS);
  ...
  const GitMerge = createLucideIcon("git-merge", __iconNode$dR);
  ...
  const GitPullRequestArrow = createLucideIcon("git-pull-request-arrow", __iconNode$dQ);
  ...
  const GitPullRequestCreateArrow = createLucideIcon("git-pull-request-create-arrow", __iconNode$dO);
  ...
  const GitPullRequestCreate = createLucideIcon("git-pull-request-create", __iconNode$dN);
  ...
  const GitPullRequestDraft = createLucideIcon("git-pull-request-draft", __iconNode$dM);
  ...
  const GitPullRequest = createLucideIcon("git-pull-request", __iconNode$dL);
  ...
  const Github = createLucideIcon("github", __iconNode$dJ);
  ...
  const Glasses = createLucideIcon("glasses", __iconNode$dI);
  ...
  const GlassWater = createLucideIcon("glass-water", __iconNode$dH);
  ...
  const GlobeLock = createLucideIcon("globe-lock", __iconNode$dG);
  ...
  const Globe = createLucideIcon("globe", __iconNode$dE);
  ...
  const Gpu = createLucideIcon("gpu", __iconNode$dD);
  ...
  const Grab = createLucideIcon("grab", __iconNode$dC);
  ...
  const GraduationCap = createLucideIcon("graduation-cap", __iconNode$dA);
  ...
  const Grid2x2Check = createLucideIcon("grid-2x2-check", __iconNode$dz);
  ...
  const Grid2x2Plus = createLucideIcon("grid-2x2-plus", __iconNode$dy);
  ...
  const Grid2x2X = createLucideIcon("grid-2x2-x", __iconNode$dx);
  ...
  const Grid2x2 = createLucideIcon("grid-2x2", __iconNode$dw);
  ...
  const Grid3x3 = createLucideIcon("grid-3x3", __iconNode$dv);
  ...
  const Guitar = createLucideIcon("guitar", __iconNode$dq);
  ...
  const Ham = createLucideIcon("ham", __iconNode$dp);
  ...
  const Hamburger = createLucideIcon("hamburger", __iconNode$do);
  ...
  const Hammer = createLucideIcon("hammer", __iconNode$dn);
  ...
  const HandCoins = createLucideIcon("hand-coins", __iconNode$dm);
  ...
  const HandHeart = createLucideIcon("hand-heart", __iconNode$dl);
  ...
  const HandHelping = createLucideIcon("hand-helping", __iconNode$dk);
  ...
  const HandMetal = createLucideIcon("hand-metal", __iconNode$dj);
  ...
  const HandPlatter = createLucideIcon("hand-platter", __iconNode$di);
  ...
  const Hand = createLucideIcon("hand", __iconNode$dh);
  ...
  const Handshake = createLucideIcon("handshake", __iconNode$dg);
  ...
  const HardDriveDownload = createLucideIcon("hard-drive-download", __iconNode$df);
  ...
  const HardDriveUpload = createLucideIcon("hard-drive-upload", __iconNode$de);
  ...
  const HardDrive = createLucideIcon("hard-drive", __iconNode$dd);
  ...
  const HardHat = createLucideIcon("hard-hat", __iconNode$dc);
  ...
  const Hash = createLucideIcon("hash", __iconNode$db);
  ...
  const Haze = createLucideIcon("haze", __iconNode$da);
  ...
  const HdmiPort = createLucideIcon("hdmi-port", __iconNode$d9);
  ...
  const Heading1 = createLucideIcon("heading-1", __iconNode$d8);
  ...
  const Heading2 = createLucideIcon("heading-2", __iconNode$d7);
  ...
  const Heading4 = createLucideIcon("heading-4", __iconNode$d5);
  ...
  const Heading5 = createLucideIcon("heading-5", __iconNode$d3);
  ...
  const Heading = createLucideIcon("heading", __iconNode$d2);
  ...
  const HeadphoneOff = createLucideIcon("headphone-off", __iconNode$d0);
  ...
  const Headset = createLucideIcon("headset", __iconNode$c$);
  ...
  const HeartCrack = createLucideIcon("heart-crack", __iconNode$c_);
  ...
  const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$cZ);
  ...
  const HeartMinus = createLucideIcon("heart-minus", __iconNode$cY);
  ...
  const HeartOff = createLucideIcon("heart-off", __iconNode$cX);
  ...
  const HeartPlus = createLucideIcon("heart-plus", __iconNode$cW);
  ...
  const HeartPulse = createLucideIcon("heart-pulse", __iconNode$cV);
  ...
  const Heart = createLucideIcon("heart", __iconNode$cU);
  ...
  const Heater = createLucideIcon("heater", __iconNode$cT);
  ...
  const Hexagon = createLucideIcon("hexagon", __iconNode$cR);
  ...
  const History = createLucideIcon("history", __iconNode$cQ);
  ...
  const HopOff = createLucideIcon("hop-off", __iconNode$cP);
  ...
  const Hop = createLucideIcon("hop", __iconNode$cO);
  ...
  const Hospital = createLucideIcon("hospital", __iconNode$cN);
  ...
  const Hotel = createLucideIcon("hotel", __iconNode$cM);
  ...
  const Hourglass = createLucideIcon("hourglass", __iconNode$cL);
  ...
  const HousePlus = createLucideIcon("house-plus", __iconNode$cK);
  ...
  const HousePlug = createLucideIcon("house-plug", __iconNode$cJ);
  ...
  const HouseWifi = createLucideIcon("house-wifi", __iconNode$cI);
  ...
  const House = createLucideIcon("house", __iconNode$cH);
  ...
  const IceCreamBowl = createLucideIcon("ice-cream-bowl", __iconNode$cG);
  ...
  const IceCreamCone = createLucideIcon("ice-cream-cone", __iconNode$cF);
  ...
  const IdCard = createLucideIcon("id-card", __iconNode$cD);
  ...
  const ImageMinus = createLucideIcon("image-minus", __iconNode$cC);
  ...
  const ImageOff = createLucideIcon("image-off", __iconNode$cB);
  ...
  const ImagePlus = createLucideIcon("image-plus", __iconNode$cz);
  ...
  const ImageUp = createLucideIcon("image-up", __iconNode$cy);
  ...
  const ImageUpscale = createLucideIcon("image-upscale", __iconNode$cx);
  ...
  const Image = createLucideIcon("image", __iconNode$cw);
  ...
  const Images = createLucideIcon("images", __iconNode$cv);
  ...
  const Inbox = createLucideIcon("inbox", __iconNode$ct);
  ...
  const IndentDecrease = createLucideIcon("indent-decrease", __iconNode$cs);
  ...
  const IndianRupee = createLucideIcon("indian-rupee", __iconNode$cq);

  const __iconNode$cp = [
    ["path", { d: "M6 16c5 0 7-8 12-8a4 4 0 0 1 0 8c-5 0-7-8-12-8a4 4 0 1 0 0 8", key: "18ogeb" }]
  ];
  const Infinity = createLucideIcon("infinity", __iconNode$cp);
  ...
  const Info = createLucideIcon("info", __iconNode$co);
  ...
  const Instagram = createLucideIcon("instagram", __iconNode$cl);

  const __iconNode$ck = [
    ["path", { d: "M20 10c0-4.4-3.6-8-8-8s-8 3.6-8 8 3.6 8 8 8h8", key: "4znkd0" }],
    ["polyline", { points: "16 14 20 18 16 22", key: "11njsm" }]
  ];
  const IterationCcw = createLucideIcon("iteration-ccw", __iconNode$ck);
  ...
  const JapaneseYen = createLucideIcon("japanese-yen", __iconNode$ci);
  ...
  const Joystick = createLucideIcon("joystick", __iconNode$ch);
  ...
  const KeyRound = createLucideIcon("key-round", __iconNode$cf);
  ...
  const KeySquare = createLucideIcon("key-square", __iconNode$ce);
  ...
  const Key = createLucideIcon("key", __iconNode$cd);
  ...
  const KeyboardMusic = createLucideIcon("keyboard-music", __iconNode$cc);
  ...
  const KeyboardOff = createLucideIcon("keyboard-off", __iconNode$cb);
  ...
  const Keyboard = createLucideIcon("keyboard", __iconNode$c9);
  ...
  const LampFloor = createLucideIcon("lamp-floor", __iconNode$c7);
  ...
  const LampWallDown = createLucideIcon("lamp-wall-down", __iconNode$c6);
  ...
  const LampWallUp = createLucideIcon("lamp-wall-up", __iconNode$c5);
  ...
  const Lamp = createLucideIcon("lamp", __iconNode$c4);
  ...
  const LandPlot = createLucideIcon("land-plot", __iconNode$c3);
  ...
  const Landmark = createLucideIcon("landmark", __iconNode$c2);
  ...
  const Languages = createLucideIcon("languages", __iconNode$c1);
  ...
  const LaptopMinimalCheck = createLucideIcon("laptop-minimal-check", __iconNode$c0);

  const __iconNode$b$ = [
    ["rect", { width: "18", height: "12", x: "3", y: "4", rx: "2", ry: "2", key: "1qhy41" }],
    ["line", { x1: "2", x2: "22", y1: "20", y2: "20", key: "ni3hll" }]
  ];
  const LaptopMinimal = createLucideIcon("laptop-minimal", __iconNode$b$);
  ...
  const Laptop = createLucideIcon("laptop", __iconNode$b_);
  ...
  const LassoSelect = createLucideIcon("lasso-select", __iconNode$bZ);
  ...
  const Lasso = createLucideIcon("lasso", __iconNode$bY);
  ...
  const Laugh = createLucideIcon("laugh", __iconNode$bX);
  ...
  const Layers2 = createLucideIcon("layers-2", __iconNode$bW);
  ...
  const Layers = createLucideIcon("layers", __iconNode$bU);
  ...
  const LayoutGrid = createLucideIcon("layout-grid", __iconNode$bT);
  ...
  const LayoutPanelLeft = createLucideIcon("layout-panel-left", __iconNode$bR);
  ...
  const LayoutPanelTop = createLucideIcon("layout-panel-top", __iconNode$bQ);
  ...
  const LayoutTemplate = createLucideIcon("layout-template", __iconNode$bO);
  ...
  const LeafyGreen = createLucideIcon("leafy-green", __iconNode$bN);
  ...
  const Lectern = createLucideIcon("lectern", __iconNode$bM);
  ...
  const LetterText = createLucideIcon("letter-text", __iconNode$bL);
  ...
  const LibraryBig = createLucideIcon("library-big", __iconNode$bK);
  ...
  const Library = createLucideIcon("library", __iconNode$bJ);
  ...
  const LifeBuoy = createLucideIcon("life-buoy", __iconNode$bH);
  ...
  const LightbulbOff = createLucideIcon("lightbulb-off", __iconNode$bG);
  ...
  const Lightbulb = createLucideIcon("lightbulb", __iconNode$bF);
  ...
  const Link2Off = createLucideIcon("link-2-off", __iconNode$bE);
  ...
  const Link2 = createLucideIcon("link-2", __iconNode$bD);

  const __iconNode$bC = [
    ["path", { d: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71", key: "1cjeqo" }],
    ["path", { d: "M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71", key: "19qd67" }]
  ];
  const Link = createLucideIcon("link", __iconNode$bC);
  ...
  const Linkedin = createLucideIcon("linkedin", __iconNode$bB);
  ...
  const ListCheck = createLucideIcon("list-check", __iconNode$bz);
  ...
  const ListFilterPlus = createLucideIcon("list-filter-plus", __iconNode$bu);
  ...
  const ListX = createLucideIcon("list-x", __iconNode$bl);
  ...
  const List = createLucideIcon("list", __iconNode$bk);
  ...
  const LocateFixed = createLucideIcon("locate-fixed", __iconNode$bf);
  ...
  const LockKeyholeOpen = createLucideIcon("lock-keyhole-open", __iconNode$bc);
  ...
  const LockKeyhole = createLucideIcon("lock-keyhole", __iconNode$bb);

  const __iconNode$ba = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 9.9-1", key: "1mm8w8" }]
  ];
  const LockOpen = createLucideIcon("lock-open", __iconNode$ba);

  const __iconNode$b9 = [
    ["rect", { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2", key: "1w4ew1" }],
    ["path", { d: "M7 11V7a5 5 0 0 1 10 0v4", key: "fwvmzm" }]
  ];
  const Lock = createLucideIcon("lock", __iconNode$b9);
  ...
  const LogIn = createLucideIcon("log-in", __iconNode$b8);
  ...
  const LogOut = createLucideIcon("log-out", __iconNode$b7);
  ...
  const Logs = createLucideIcon("logs", __iconNode$b6);
  ...
  const Lollipop = createLucideIcon("lollipop", __iconNode$b5);
  ...
  const Luggage = createLucideIcon("luggage", __iconNode$b4);
  ...
  const Magnet = createLucideIcon("magnet", __iconNode$b3);
  ...
  const MailCheck = createLucideIcon("mail-check", __iconNode$b2);
  ...
  const MailMinus = createLucideIcon("mail-minus", __iconNode$b1);
  ...
  const MailQuestion = createLucideIcon("mail-question", __iconNode$a_);
  ...
  const MailSearch = createLucideIcon("mail-search", __iconNode$aY);
  ...
  const MailX = createLucideIcon("mail-x", __iconNode$aX);
  ...
  const Mailbox = createLucideIcon("mailbox", __iconNode$aV);
  ...
  const Mails = createLucideIcon("mails", __iconNode$aU);
  ...
  const MapPinCheckInside = createLucideIcon("map-pin-check-inside", __iconNode$aT);
  ...
  const MapPinCheck = createLucideIcon("map-pin-check", __iconNode$aS);
  ...
  const MapPinHouse = createLucideIcon("map-pin-house", __iconNode$aR);
  ...
  const MapPinMinusInside = createLucideIcon("map-pin-minus-inside", __iconNode$aQ);
  ...
  const MapPinMinus = createLucideIcon("map-pin-minus", __iconNode$aP);
  ...
  const MapPinOff = createLucideIcon("map-pin-off", __iconNode$aO);
  ...
  const MapPinPlusInside = createLucideIcon("map-pin-plus-inside", __iconNode$aN);
  ...
  const MapPinPlus = createLucideIcon("map-pin-plus", __iconNode$aM);
  ...
  const MapPinXInside = createLucideIcon("map-pin-x-inside", __iconNode$aL);
  ...
  const MapPinX = createLucideIcon("map-pin-x", __iconNode$aK);
  ...
  const MapPin = createLucideIcon("map-pin", __iconNode$aJ);
  ...
  const MapPinned = createLucideIcon("map-pinned", __iconNode$aI);
  ...
  const MapPlus = createLucideIcon("map-plus", __iconNode$aH);
  ...
  const Map = createLucideIcon("map", __iconNode$aG);
  ...
  const MarsStroke = createLucideIcon("mars-stroke", __iconNode$aF);
  ...
  const Mars = createLucideIcon("mars", __iconNode$aE);
  ...
  const Martini = createLucideIcon("martini", __iconNode$aD);
  ...
  const Maximize2 = createLucideIcon("maximize-2", __iconNode$aC);
  ...
  const Maximize = createLucideIcon("maximize", __iconNode$aB);
  ...
  const Medal = createLucideIcon("medal", __iconNode$aA);
  ...
  const MegaphoneOff = createLucideIcon("megaphone-off", __iconNode$az);

  const __iconNode$ay = [
    ["path", { d: "m3 11 18-5v12L3 14v-3z", key: "n962bs" }],
    ["path", { d: "M11.6 16.8a3 3 0 1 1-5.8-1.6", key: "1yl0tm" }]
  ];
  const Megaphone = createLucideIcon("megaphone", __iconNode$ay);
  ...
  const Meh = createLucideIcon("meh", __iconNode$ax);
  ...
  const MemoryStick = createLucideIcon("memory-stick", __iconNode$aw);
  ...
  const Merge = createLucideIcon("merge", __iconNode$au);
  ...
  const MessageCircleCode = createLucideIcon("message-circle-code", __iconNode$at);
  ...
  const MessageCircleDashed = createLucideIcon("message-circle-dashed", __iconNode$as);
  ...
  const MessageCircleHeart = createLucideIcon("message-circle-heart", __iconNode$ar);
  ...
  const MessageCircleMore = createLucideIcon("message-circle-more", __iconNode$aq);
  ...
  const MessageCircleQuestion = createLucideIcon("message-circle-question", __iconNode$an);
  ...
  const MessageCircleReply = createLucideIcon("message-circle-reply", __iconNode$am);
  ...
  const MessageCircleWarning = createLucideIcon("message-circle-warning", __iconNode$al);
  ...
  const MessageCircleX = createLucideIcon("message-circle-x", __iconNode$ak);

  const __iconNode$aj = [
    ["path", { d: "M7.9 20A9 9 0 1 0 4 16.1L2 22Z", key: "vv11sd" }]
  ];
  const MessageCircle = createLucideIcon("message-circle", __iconNode$aj);
  ...
  const MessageSquareCode = createLucideIcon("message-square-code", __iconNode$ai);
  ...
  const MessageSquareDashed = createLucideIcon("message-square-dashed", __iconNode$ah);
  ...
  const MessageSquareDiff = createLucideIcon("message-square-diff", __iconNode$ag);

  const __iconNode$af = [
    ["path", { d: "M11.7 3H5a2 2 0 0 0-2 2v16l4-4h12a2 2 0 0 0 2-2v-2.7", key: "uodpkb" }],
    ["circle", { cx: "18", cy: "6", r: "3", key: "1h7g24" }]
  ];
  const MessageSquareDot = createLucideIcon("message-square-dot", __iconNode$af);
  ...
  const MessageSquareHeart = createLucideIcon("message-square-heart", __iconNode$ae);
  ...
  const MessageSquareLock = createLucideIcon("message-square-lock", __iconNode$ad);
  ...
  const MessageSquareMore = createLucideIcon("message-square-more", __iconNode$ac);
  ...
  const MessageSquareQuote = createLucideIcon("message-square-quote", __iconNode$a9);
  ...
  const MessageSquareReply = createLucideIcon("message-square-reply", __iconNode$a8);
  ...
  const MessageSquareShare = createLucideIcon("message-square-share", __iconNode$a7);
  ...
  const MessageSquareText = createLucideIcon("message-square-text", __iconNode$a6);
  ...
  const MessageSquareWarning = createLucideIcon("message-square-warning", __iconNode$a4);

  const __iconNode$a3 = [
    ["path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z", key: "1lielz" }]
  ];
  const MessageSquare = createLucideIcon("message-square", __iconNode$a3);
  ...
  const MessagesSquare = createLucideIcon("messages-square", __iconNode$a2);
  ...
  const MicOff = createLucideIcon("mic-off", __iconNode$a1);
  ...
  const MicVocal = createLucideIcon("mic-vocal", __iconNode$a0);
  ...
  const Mic = createLucideIcon("mic", __iconNode$9_);
  ...
  const Microscope = createLucideIcon("microscope", __iconNode$9Z);
  ...
  const Microwave = createLucideIcon("microwave", __iconNode$9Y);
  ...
  const Milestone = createLucideIcon("milestone", __iconNode$9X);
  ...
  const MilkOff = createLucideIcon("milk-off", __iconNode$9W);
  ...
  const Milk = createLucideIcon("milk", __iconNode$9V);
  ...
  const Minimize2 = createLucideIcon("minimize-2", __iconNode$9U);
  ...
  const __iconNode$9S = [["path", { d: "M5 12h14", key: "1ays0h" }]];
  const Minus = createLucideIcon("minus", __iconNode$9S);
  ...
  const MonitorCheck = createLucideIcon("monitor-check", __iconNode$9R);
  ...
  const MonitorCog = createLucideIcon("monitor-cog", __iconNode$9Q);
  ...
  const MonitorDot = createLucideIcon("monitor-dot", __iconNode$9P);
  ...
  const MonitorDown = createLucideIcon("monitor-down", __iconNode$9O);
  ...
  const MonitorOff = createLucideIcon("monitor-off", __iconNode$9N);
  ...
  const MonitorPause = createLucideIcon("monitor-pause", __iconNode$9M);
  ...
  const MonitorPlay = createLucideIcon("monitor-play", __iconNode$9L);
  ...
  const MonitorSpeaker = createLucideIcon("monitor-speaker", __iconNode$9K);
  ...
  const MonitorStop = createLucideIcon("monitor-stop", __iconNode$9I);
  ...
  const MonitorUp = createLucideIcon("monitor-up", __iconNode$9H);
  ...
  const MonitorX = createLucideIcon("monitor-x", __iconNode$9G);
  ...
  const Monitor = createLucideIcon("monitor", __iconNode$9F);
  ...
  const MoonStar = createLucideIcon("moon-star", __iconNode$9E);

  const __iconNode$9D = [
    ["path", { d: "M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z", key: "a7tn18" }]
  ];
  const Moon = createLucideIcon("moon", __iconNode$9D);
  ...
  const MountainSnow = createLucideIcon("mountain-snow", __iconNode$9C);

  const __iconNode$9B = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]];
  const Mountain = createLucideIcon("mountain", __iconNode$9B);
  ...
  const MouseOff = createLucideIcon("mouse-off", __iconNode$9A);
  ...
  const MousePointer2 = createLucideIcon("mouse-pointer-2", __iconNode$9z);
  ...
  const MousePointerBan = createLucideIcon("mouse-pointer-ban", __iconNode$9y);
  ...
  const MousePointerClick = createLucideIcon("mouse-pointer-click", __iconNode$9x);
  ...
  const Mouse = createLucideIcon("mouse", __iconNode$9v);
  ...
  const Move3d = createLucideIcon("move-3d", __iconNode$9u);
  ...
  const MoveDiagonal2 = createLucideIcon("move-diagonal-2", __iconNode$9t);
  ...
  const MoveDiagonal = createLucideIcon("move-diagonal", __iconNode$9s);

  const __iconNode$9r = [
    ["path", { d: "M11 19H5V13", key: "1akmht" }],
    ["path", { d: "M19 5L5 19", key: "72u4yj" }]
  ];
  const MoveDownLeft = createLucideIcon("move-down-left", __iconNode$9r);

  const __iconNode$9q = [
    ["path", { d: "M19 13V19H13", key: "10vkzq" }],
    ["path", { d: "M5 5L19 19", key: "5zm2fv" }]
  ];
  const MoveDownRight = createLucideIcon("move-down-right", __iconNode$9q);

  const __iconNode$9p = [
    ["path", { d: "M8 18L12 22L16 18", key: "cskvfv" }],
    ["path", { d: "M12 2V22", key: "r89rzk" }]
  ];
  const MoveDown = createLucideIcon("move-down", __iconNode$9p);
  ...
  const MoveHorizontal = createLucideIcon("move-horizontal", __iconNode$9o);

  const __iconNode$9n = [
    ["path", { d: "M6 8L2 12L6 16", key: "kyvwex" }],
    ["path", { d: "M2 12H22", key: "1m8cig" }]
  ];
  const MoveLeft = createLucideIcon("move-left", __iconNode$9n);
  ...
  const MoveUpLeft = createLucideIcon("move-up-left", __iconNode$9l);

  const __iconNode$9k = [
    ["path", { d: "M13 5H19V11", key: "1n1gyv" }],
    ["path", { d: "M19 5L5 19", key: "72u4yj" }]
  ];
  const MoveUpRight = createLucideIcon("move-up-right", __iconNode$9k);

  const __iconNode$9j = [
    ["path", { d: "M8 6L12 2L16 6", key: "1yvkyx" }],
    ["path", { d: "M12 2V22", key: "r89rzk" }]
  ];
  const MoveUp = createLucideIcon("move-up", __iconNode$9j);
  ...
  const MoveVertical = createLucideIcon("move-vertical", __iconNode$9i);
  ...
  const Move = createLucideIcon("move", __iconNode$9h);

  const __iconNode$9g = [
    ["circle", { cx: "8", cy: "18", r: "4", key: "1fc0mg" }],
    ["path", { d: "M12 18V2l7 4", key: "g04rme" }]
  ];
  const Music2 = createLucideIcon("music-2", __iconNode$9g);

  const __iconNode$9f = [
    ["circle", { cx: "12", cy: "18", r: "4", key: "m3r9ws" }],
    ["path", { d: "M16 18V2", key: "40x2m5" }]
  ];
  const Music3 = createLucideIcon("music-3", __iconNode$9f);
  ...
  const Music4 = createLucideIcon("music-4", __iconNode$9e);
  ...
  const Music = createLucideIcon("music", __iconNode$9d);
  ...
  const Navigation2 = createLucideIcon("navigation-2", __iconNode$9b);
  ...
  const NavigationOff = createLucideIcon("navigation-off", __iconNode$9a);

  const __iconNode$99 = [
    ["polygon", { points: "3 11 22 2 13 21 11 13 3 11", key: "1ltx0t" }]
  ];
  const Navigation = createLucideIcon("navigation", __iconNode$99);
  ...
  const Newspaper = createLucideIcon("newspaper", __iconNode$97);
  ...
  const Nfc = createLucideIcon("nfc", __iconNode$96);
  ...
  const NonBinary = createLucideIcon("non-binary", __iconNode$95);
  ...
  const NotebookPen = createLucideIcon("notebook-pen", __iconNode$94);
  ...
  const NotebookTabs = createLucideIcon("notebook-tabs", __iconNode$93);
  ...
  const NotebookText = createLucideIcon("notebook-text", __iconNode$92);
  ...
  const Notebook = createLucideIcon("notebook", __iconNode$91);
  ...
  const NotepadTextDashed = createLucideIcon("notepad-text-dashed", __iconNode$90);
  ...
  const NotepadText = createLucideIcon("notepad-text", __iconNode$8$);
  ...
  const NutOff = createLucideIcon("nut-off", __iconNode$8Z);
  ...
  const OctagonAlert = createLucideIcon("octagon-alert", __iconNode$8Y);
  ...
  const OctagonMinus = createLucideIcon("octagon-minus", __iconNode$8X);
  ...
  const OctagonPause = createLucideIcon("octagon-pause", __iconNode$8W);
  ...
  const OctagonX = createLucideIcon("octagon-x", __iconNode$8V);
  ...
  const Omega = createLucideIcon("omega", __iconNode$8T);

  const __iconNode$8S = [
    ["path", { d: "M3 3h6l6 18h6", key: "ph9rgk" }],
    ["path", { d: "M14 3h7", key: "16f0ms" }]
  ];
  const Option = createLucideIcon("option", __iconNode$8S);
  ...
  const Orbit = createLucideIcon("orbit", __iconNode$8R);
  ...
  const Origami = createLucideIcon("origami", __iconNode$8Q);
  ...
  const Package2 = createLucideIcon("package-2", __iconNode$8P);
  ...
  const PackageCheck = createLucideIcon("package-check", __iconNode$8O);
  ...
  const PackageMinus = createLucideIcon("package-minus", __iconNode$8N);
  ...
  const PackageOpen = createLucideIcon("package-open", __iconNode$8M);
  ...
  const PackagePlus = createLucideIcon("package-plus", __iconNode$8L);
  ...
  const PackageSearch = createLucideIcon("package-search", __iconNode$8K);
  ...
  const PackageX = createLucideIcon("package-x", __iconNode$8J);
  ...
  const Package = createLucideIcon("package", __iconNode$8I);
  ...
  const PaintBucket = createLucideIcon("paint-bucket", __iconNode$8H);
  ...
  const PaintRoller = createLucideIcon("paint-roller", __iconNode$8G);
  ...
  const PaintbrushVertical = createLucideIcon("paintbrush-vertical", __iconNode$8F);
  ...
  const Paintbrush = createLucideIcon("paintbrush", __iconNode$8E);
  ...
  const Palette = createLucideIcon("palette", __iconNode$8D);
  ...
  const Panda = createLucideIcon("panda", __iconNode$8B);
  ...
  const PanelBottomDashed = createLucideIcon("panel-bottom-dashed", __iconNode$8A);
  ...
  const PanelBottomOpen = createLucideIcon("panel-bottom-open", __iconNode$8z);

  const __iconNode$8y = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 15h18", key: "5xshup" }]
  ];
  const PanelBottom = createLucideIcon("panel-bottom", __iconNode$8y);
  ...
  const PanelLeftClose = createLucideIcon("panel-left-close", __iconNode$8x);
  ...
  const PanelLeftDashed = createLucideIcon("panel-left-dashed", __iconNode$8w);
  ...
  const PanelLeftOpen = createLucideIcon("panel-left-open", __iconNode$8v);

  const __iconNode$8u = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M9 3v18", key: "fh3hqa" }]
  ];
  const PanelLeft = createLucideIcon("panel-left", __iconNode$8u);
  ...
  const PanelRightClose = createLucideIcon("panel-right-close", __iconNode$8t);
  ...
  const PanelRightDashed = createLucideIcon("panel-right-dashed", __iconNode$8s);
  ...
  const PanelRightOpen = createLucideIcon("panel-right-open", __iconNode$8r);

  const __iconNode$8q = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M15 3v18", key: "14nvp0" }]
  ];
  const PanelRight = createLucideIcon("panel-right", __iconNode$8q);
  ...
  const PanelTopClose = createLucideIcon("panel-top-close", __iconNode$8p);
  ...
  const PanelTopDashed = createLucideIcon("panel-top-dashed", __iconNode$8o);
  ...
  const PanelTopOpen = createLucideIcon("panel-top-open", __iconNode$8n);

  const __iconNode$8m = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 9h18", key: "1pudct" }]
  ];
  const PanelTop = createLucideIcon("panel-top", __iconNode$8m);
  ...
  const PanelsLeftBottom = createLucideIcon("panels-left-bottom", __iconNode$8l);
  ...
  const PanelsRightBottom = createLucideIcon("panels-right-bottom", __iconNode$8k);
  ...
  const PanelsTopLeft = createLucideIcon("panels-top-left", __iconNode$8j);
  ...
  const Paperclip = createLucideIcon("paperclip", __iconNode$8i);
  ...
  const Parentheses = createLucideIcon("parentheses", __iconNode$8g);
  ...
  const PartyPopper = createLucideIcon("party-popper", __iconNode$8f);

  const __iconNode$8e = [
    ["rect", { x: "14", y: "4", width: "4", height: "16", rx: "1", key: "zuxfzm" }],
    ["rect", { x: "6", y: "4", width: "4", height: "16", rx: "1", key: "1okwgv" }]
  ];
  const Pause = createLucideIcon("pause", __iconNode$8e);
  ...
  const PcCase = createLucideIcon("pc-case", __iconNode$8c);
  ...
  const PenLine = createLucideIcon("pen-line", __iconNode$8b);
  ...
  const PenOff = createLucideIcon("pen-off", __iconNode$8a);
  ...
  const PenTool = createLucideIcon("pen-tool", __iconNode$89);
  ...
  const Pen = createLucideIcon("pen", __iconNode$88);
  ...
  const PencilLine = createLucideIcon("pencil-line", __iconNode$87);
  ...
  const PencilOff = createLucideIcon("pencil-off", __iconNode$86);
  ...
  const PencilRuler = createLucideIcon("pencil-ruler", __iconNode$85);
  ...
  const Pencil = createLucideIcon("pencil", __iconNode$84);
  ...
  const Pentagon = createLucideIcon("pentagon", __iconNode$83);
  ...
  const Percent = createLucideIcon("percent", __iconNode$82);
  ...
  const PersonStanding = createLucideIcon("person-standing", __iconNode$81);
  ...
  const PhilippinePeso = createLucideIcon("philippine-peso", __iconNode$80);
  ...
  const PhoneCall = createLucideIcon("phone-call", __iconNode$7$);
  ...
  const PhoneForwarded = createLucideIcon("phone-forwarded", __iconNode$7_);
  ...
  const PhoneIncoming = createLucideIcon("phone-incoming", __iconNode$7Z);
  ...
  const PhoneMissed = createLucideIcon("phone-missed", __iconNode$7Y);
  ...
  const PhoneOff = createLucideIcon("phone-off", __iconNode$7X);
  ...
  const PhoneOutgoing = createLucideIcon("phone-outgoing", __iconNode$7W);
  ...
  const Phone = createLucideIcon("phone", __iconNode$7V);
  ...
  const Piano = createLucideIcon("piano", __iconNode$7T);
  ...
  const Pickaxe = createLucideIcon("pickaxe", __iconNode$7S);

  const __iconNode$7R = [
    ["path", { d: "M21 9V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10c0 1.1.9 2 2 2h4", key: "daa4of" }],
    ["rect", { width: "10", height: "7", x: "12", y: "13", rx: "2", key: "1nb8gs" }]
  ];
  const PictureInPicture2 = createLucideIcon("picture-in-picture-2", __iconNode$7R);
  ...
  const PictureInPicture = createLucideIcon("picture-in-picture", __iconNode$7Q);
  ...
  const PiggyBank = createLucideIcon("piggy-bank", __iconNode$7P);
  ...
  const PilcrowRight = createLucideIcon("pilcrow-right", __iconNode$7O);
  ...
  const PilcrowLeft = createLucideIcon("pilcrow-left", __iconNode$7N);
  ...
  const Pilcrow = createLucideIcon("pilcrow", __iconNode$7M);
  ...
  const PillBottle = createLucideIcon("pill-bottle", __iconNode$7L);
  ...
  const Pill = createLucideIcon("pill", __iconNode$7K);
  ...
  const PinOff = createLucideIcon("pin-off", __iconNode$7J);
  ...
  const Pin = createLucideIcon("pin", __iconNode$7I);
  ...
  const Pipette = createLucideIcon("pipette", __iconNode$7H);
  ...
  const Pizza = createLucideIcon("pizza", __iconNode$7F);
  ...
  const PlaneTakeoff = createLucideIcon("plane-takeoff", __iconNode$7E);
  ...
  const Plane = createLucideIcon("plane", __iconNode$7D);

  const __iconNode$7C = [["polygon", { points: "6 3 20 12 6 21 6 3", key: "1oa8hb" }]];
  const Play = createLucideIcon("play", __iconNode$7C);
  ...
  const Plug2 = createLucideIcon("plug-2", __iconNode$7B);
  ...
  const PlugZap = createLucideIcon("plug-zap", __iconNode$7A);
  ...
  const Plug = createLucideIcon("plug", __iconNode$7z);

  const __iconNode$7y = [
    ["path", { d: "M5 12h14", key: "1ays0h" }],
    ["path", { d: "M12 5v14", key: "s699le" }]
  ];
  const Plus = createLucideIcon("plus", __iconNode$7y);
  ...
  const PocketKnife = createLucideIcon("pocket-knife", __iconNode$7x);
  ...
  const Pocket = createLucideIcon("pocket", __iconNode$7w);
  ...
  const Podcast = createLucideIcon("podcast", __iconNode$7v);
  ...
  const PointerOff = createLucideIcon("pointer-off", __iconNode$7u);
  ...
  const Pointer = createLucideIcon("pointer", __iconNode$7t);
  ...
  const Popcorn = createLucideIcon("popcorn", __iconNode$7s);
  ...
  const Popsicle = createLucideIcon("popsicle", __iconNode$7r);
  ...
  const PowerOff = createLucideIcon("power-off", __iconNode$7p);

  const __iconNode$7o = [
    ["path", { d: "M12 2v10", key: "mnfbl" }],
    ["path", { d: "M18.4 6.6a9 9 0 1 1-12.77.04", key: "obofu9" }]
  ];
  const Power = createLucideIcon("power", __iconNode$7o);
  ...
  const Presentation = createLucideIcon("presentation", __iconNode$7n);
  ...
  const PrinterCheck = createLucideIcon("printer-check", __iconNode$7m);
  ...
  const Printer = createLucideIcon("printer", __iconNode$7k);
  ...
  const Proportions = createLucideIcon("proportions", __iconNode$7j);
  ...
  const Puzzle = createLucideIcon("puzzle", __iconNode$7i);
  ...
  const Pyramid = createLucideIcon("pyramid", __iconNode$7h);
  ...
  const QrCode = createLucideIcon("qr-code", __iconNode$7g);
  ...
  const Quote = createLucideIcon("quote", __iconNode$7f);
  ...
  const Rabbit = createLucideIcon("rabbit", __iconNode$7e);
  ...
  const Radar = createLucideIcon("radar", __iconNode$7d);
  ...
  const Radiation = createLucideIcon("radiation", __iconNode$7c);
  ...
  const Radical = createLucideIcon("radical", __iconNode$7b);
  ...
  const RadioTower = createLucideIcon("radio-tower", __iconNode$79);
  ...
  const Radio = createLucideIcon("radio", __iconNode$78);
  ...
  const Radius = createLucideIcon("radius", __iconNode$77);
  ...
  const RailSymbol = createLucideIcon("rail-symbol", __iconNode$76);
  ...
  const Rainbow = createLucideIcon("rainbow", __iconNode$75);
  ...
  const Ratio = createLucideIcon("ratio", __iconNode$73);
  ...
  const ReceiptCent = createLucideIcon("receipt-cent", __iconNode$71);
  ...
  const ReceiptIndianRupee = createLucideIcon("receipt-indian-rupee", __iconNode$70);
  ...
  const ReceiptJapaneseYen = createLucideIcon("receipt-japanese-yen", __iconNode$6$);
  ...
  const ReceiptPoundSterling = createLucideIcon("receipt-pound-sterling", __iconNode$6_);
  ...
  const ReceiptRussianRuble = createLucideIcon("receipt-russian-ruble", __iconNode$6Z);
  ...
  const ReceiptSwissFranc = createLucideIcon("receipt-swiss-franc", __iconNode$6Y);
  ...
  const ReceiptText = createLucideIcon("receipt-text", __iconNode$6W);
  ...
  const RectangleEllipsis = createLucideIcon("rectangle-ellipsis", __iconNode$6V);
  ...
  const RectangleGoggles = createLucideIcon("rectangle-goggles", __iconNode$6U);

  const __iconNode$6T = [
    ["rect", { width: "20", height: "12", x: "2", y: "6", rx: "2", key: "9lu3g6" }]
  ];
  const RectangleHorizontal = createLucideIcon("rectangle-horizontal", __iconNode$6T);

  const __iconNode$6S = [
    ["rect", { width: "12", height: "20", x: "6", y: "2", rx: "2", key: "1oxtiu" }]
  ];
  const RectangleVertical = createLucideIcon("rectangle-vertical", __iconNode$6S);
  ...
  const Recycle = createLucideIcon("recycle", __iconNode$6R);

  const __iconNode$6Q = [
    ["path", { d: "m15 14 5-5-5-5", key: "12vg1m" }],
    ["path", { d: "M20 9H9.5A5.5 5.5 0 0 0 4 14.5A5.5 5.5 0 0 0 9.5 20H13", key: "6uklza" }]
  ];
  const Redo2 = createLucideIcon("redo-2", __iconNode$6Q);
  ...
  const RedoDot = createLucideIcon("redo-dot", __iconNode$6P);

  const __iconNode$6O = [
    ["path", { d: "M21 7v6h-6", key: "3ptur4" }],
    ["path", { d: "M3 17a9 9 0 0 1 9-9 9 9 0 0 1 6 2.3l3 2.7", key: "1kgawr" }]
  ];
  const Redo = createLucideIcon("redo", __iconNode$6O);
  ...
  const RefreshCcwDot = createLucideIcon("refresh-ccw-dot", __iconNode$6N);
  ...
  const RefreshCcw = createLucideIcon("refresh-ccw", __iconNode$6M);
  ...
  const RefreshCwOff = createLucideIcon("refresh-cw-off", __iconNode$6L);
  ...
  const RefreshCw = createLucideIcon("refresh-cw", __iconNode$6K);
  ...
  const Refrigerator = createLucideIcon("refrigerator", __iconNode$6J);
  ...
  const Regex = createLucideIcon("regex", __iconNode$6I);
  ...
  const RemoveFormatting = createLucideIcon("remove-formatting", __iconNode$6H);
  ...
  const Repeat1 = createLucideIcon("repeat-1", __iconNode$6G);
  ...
  const Repeat2 = createLucideIcon("repeat-2", __iconNode$6F);
  ...
  const Repeat = createLucideIcon("repeat", __iconNode$6E);
  ...
  const ReplaceAll = createLucideIcon("replace-all", __iconNode$6D);
  ...
  const ReplyAll = createLucideIcon("reply-all", __iconNode$6B);

  const __iconNode$6A = [
    ["polyline", { points: "9 17 4 12 9 7", key: "hvgpf2" }],
    ["path", { d: "M20 18v-2a4 4 0 0 0-4-4H4", key: "5vmcpk" }]
  ];
  const Reply = createLucideIcon("reply", __iconNode$6A);
  ...
  const Rotate3d = createLucideIcon("rotate-3d", __iconNode$6u);
  ...
  const RotateCcwKey = createLucideIcon("rotate-ccw-key", __iconNode$6t);
  ...
  const RotateCcwSquare = createLucideIcon("rotate-ccw-square", __iconNode$6s);
  ...
  const RotateCwSquare = createLucideIcon("rotate-cw-square", __iconNode$6q);

  const __iconNode$6p = [
    ["path", { d: "M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8", key: "1p45f6" }],
    ["path", { d: "M21 3v5h-5", key: "1q7to0" }]
  ];
  const RotateCw = createLucideIcon("rotate-cw", __iconNode$6p);
  ...
  const RouteOff = createLucideIcon("route-off", __iconNode$6o);
  ...
  const Router = createLucideIcon("router", __iconNode$6m);

  const __iconNode$6l = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M3 12h18", key: "1i2n21" }]
  ];
  const Rows2 = createLucideIcon("rows-2", __iconNode$6l);
  ...
  const Rows3 = createLucideIcon("rows-3", __iconNode$6k);
  ...
  const Rows4 = createLucideIcon("rows-4", __iconNode$6j);
  ...
  const Rss = createLucideIcon("rss", __iconNode$6i);
  ...
  const RulerDimensionLine = createLucideIcon("ruler-dimension-line", __iconNode$6h);
  ...
  const Ruler = createLucideIcon("ruler", __iconNode$6g);

  const __iconNode$6f = [
    ["path", { d: "M6 11h8a4 4 0 0 0 0-8H9v18", key: "18ai8t" }],
    ["path", { d: "M6 15h8", key: "1y8f6l" }]
  ];
  const RussianRuble = createLucideIcon("russian-ruble", __iconNode$6f);
  ...
  const SatelliteDish = createLucideIcon("satellite-dish", __iconNode$6b);
  ...
  const Satellite = createLucideIcon("satellite", __iconNode$6a);
  ...
  const SaudiRiyal = createLucideIcon("saudi-riyal", __iconNode$69);
  ...
  const SaveAll = createLucideIcon("save-all", __iconNode$68);
  ...
  const Save = createLucideIcon("save", __iconNode$66);
  ...
  const Scale3d = createLucideIcon("scale-3d", __iconNode$64);
  ...
  const Scaling = createLucideIcon("scaling", __iconNode$63);
  ...
  const ScanBarcode = createLucideIcon("scan-barcode", __iconNode$62);
  ...
  const ScanEye = createLucideIcon("scan-eye", __iconNode$61);
  ...
  const ScanHeart = createLucideIcon("scan-heart", __iconNode$5$);
  ...
  const ScanLine = createLucideIcon("scan-line", __iconNode$5_);
  ...
  const ScanQrCode = createLucideIcon("scan-qr-code", __iconNode$5Z);
  ...
  const ScanSearch = createLucideIcon("scan-search", __iconNode$5Y);
  ...
  const ScanText = createLucideIcon("scan-text", __iconNode$5X);
  ...
  const Scan = createLucideIcon("scan", __iconNode$5W);
  ...
  const School = createLucideIcon("school", __iconNode$5V);
  ...
  const ScissorsLineDashed = createLucideIcon("scissors-line-dashed", __iconNode$5U);
  ...
  const Scissors = createLucideIcon("scissors", __iconNode$5T);
  ...
  const ScreenShareOff = createLucideIcon("screen-share-off", __iconNode$5S);
  ...
  const ScreenShare = createLucideIcon("screen-share", __iconNode$5R);
  ...
  const ScrollText = createLucideIcon("scroll-text", __iconNode$5Q);
  ...
  const Scroll = createLucideIcon("scroll", __iconNode$5P);
  ...
  const SearchCheck = createLucideIcon("search-check", __iconNode$5O);
  ...
  const SearchCode = createLucideIcon("search-code", __iconNode$5N);
  ...
  const SearchSlash = createLucideIcon("search-slash", __iconNode$5L);

  const __iconNode$5K = [
    ["path", { d: "m21 21-4.34-4.34", key: "14j7rj" }],
    ["circle", { cx: "11", cy: "11", r: "8", key: "4ej97u" }]
  ];
  const Search = createLucideIcon("search", __iconNode$5K);
  ...
  const SendHorizontal = createLucideIcon("send-horizontal", __iconNode$5I);
  ...
  const SendToBack = createLucideIcon("send-to-back", __iconNode$5H);
  ...
  const Send = createLucideIcon("send", __iconNode$5G);
  ...
  const SeparatorHorizontal = createLucideIcon("separator-horizontal", __iconNode$5F);
  ...
  const SeparatorVertical = createLucideIcon("separator-vertical", __iconNode$5E);
  ...
  const ServerCog = createLucideIcon("server-cog", __iconNode$5D);
  ...
  const ServerCrash = createLucideIcon("server-crash", __iconNode$5C);
  ...
  const ServerOff = createLucideIcon("server-off", __iconNode$5B);
  ...
  const Settings2 = createLucideIcon("settings-2", __iconNode$5z);
  ...
  const Shapes = createLucideIcon("shapes", __iconNode$5x);
  ...
  const Share2 = createLucideIcon("share-2", __iconNode$5w);
  ...
  const Sheet = createLucideIcon("sheet", __iconNode$5u);
  ...
  const Shell = createLucideIcon("shell", __iconNode$5t);
  ...
  const ShieldAlert = createLucideIcon("shield-alert", __iconNode$5s);
  ...
  const ShieldBan = createLucideIcon("shield-ban", __iconNode$5r);
  ...
  const ShieldCheck = createLucideIcon("shield-check", __iconNode$5q);
  ...
  const ShieldEllipsis = createLucideIcon("shield-ellipsis", __iconNode$5p);
  ...
  const ShieldMinus = createLucideIcon("shield-minus", __iconNode$5n);
  ...
  const ShieldPlus = createLucideIcon("shield-plus", __iconNode$5l);
  ...
  const ShieldQuestion = createLucideIcon("shield-question", __iconNode$5k);
  ...
  const ShieldUser = createLucideIcon("shield-user", __iconNode$5j);
  ...
  const ShieldX = createLucideIcon("shield-x", __iconNode$5i);
  ...
  const Shield = createLucideIcon("shield", __iconNode$5h);
  ...
  const ShipWheel = createLucideIcon("ship-wheel", __iconNode$5g);
  ...
  const Shirt = createLucideIcon("shirt", __iconNode$5e);
  ...
  const ShoppingCart = createLucideIcon("shopping-cart", __iconNode$5b);
  ...
  const Shovel = createLucideIcon("shovel", __iconNode$5a);
  ...
  const ShowerHead = createLucideIcon("shower-head", __iconNode$59);
  ...
  const Shredder = createLucideIcon("shredder", __iconNode$58);
  ...
  const Shrimp = createLucideIcon("shrimp", __iconNode$57);
  ...
  const Shrink = createLucideIcon("shrink", __iconNode$56);
  ...
  const Shrub = createLucideIcon("shrub", __iconNode$55);
  ...
  const Shuffle = createLucideIcon("shuffle", __iconNode$54);
  ...
  const Sigma = createLucideIcon("sigma", __iconNode$53);
  ...
  const SignalHigh = createLucideIcon("signal-high", __iconNode$52);

  const __iconNode$51 = [
    ["path", { d: "M2 20h.01", key: "4haj6o" }],
    ["path", { d: "M7 20v-4", key: "j294jx" }]
  ];
  const SignalLow = createLucideIcon("signal-low", __iconNode$51);
  ...
  const SignalMedium = createLucideIcon("signal-medium", __iconNode$50);

  const __iconNode$4$ = [["path", { d: "M2 20h.01", key: "4haj6o" }]];
  const SignalZero = createLucideIcon("signal-zero", __iconNode$4$);
  ...
  const Signal = createLucideIcon("signal", __iconNode$4_);
  ...
  const Signature = createLucideIcon("signature", __iconNode$4Z);
  ...
  const Signpost = createLucideIcon("signpost", __iconNode$4X);
  ...
  const Siren = createLucideIcon("siren", __iconNode$4W);

  const __iconNode$4V = [
    ["polygon", { points: "19 20 9 12 19 4 19 20", key: "o2sva" }],
    ["line", { x1: "5", x2: "5", y1: "19", y2: "5", key: "1ocqjk" }]
  ];
  const SkipBack = createLucideIcon("skip-back", __iconNode$4V);
  ...
  const SkipForward = createLucideIcon("skip-forward", __iconNode$4T);
  ...
  const Slack = createLucideIcon("slack", __iconNode$4S);

  const __iconNode$4R = [["path", { d: "M22 2 2 22", key: "y4kqgn" }]];
  const Slash = createLucideIcon("slash", __iconNode$4R);
  ...
  const Slice = createLucideIcon("slice", __iconNode$4Q);
  ...
  const SlidersHorizontal = createLucideIcon("sliders-horizontal", __iconNode$4P);
  ...
  const SlidersVertical = createLucideIcon("sliders-vertical", __iconNode$4O);

  const __iconNode$4N = [
    ["rect", { width: "14", height: "20", x: "5", y: "2", rx: "2", ry: "2", key: "1yt0o3" }],
    ["path", { d: "M12.667 8 10 12h4l-2.667 4", key: "h9lk2d" }]
  ];
  const SmartphoneCharging = createLucideIcon("smartphone-charging", __iconNode$4N);
  ...
  const SmartphoneNfc = createLucideIcon("smartphone-nfc", __iconNode$4K);
  ...
  const Smile = createLucideIcon("smile", __iconNode$4J);
  ...
  const Snail = createLucideIcon("snail", __iconNode$4I);
  ...
  const Snowflake = createLucideIcon("snowflake", __iconNode$4H);
  ...
  const SoapDispenserDroplet = createLucideIcon("soap-dispenser-droplet", __iconNode$4G);
  ...
  const Sofa = createLucideIcon("sofa", __iconNode$4F);
  ...
  const Soup = createLucideIcon("soup", __iconNode$4E);

  const __iconNode$4D = [
    ["path", { d: "M22 17v1c0 .5-.5 1-1 1H3c-.5 0-1-.5-1-1v-1", key: "lt2kga" }]
  ];
  const Space = createLucideIcon("space", __iconNode$4D);
  ...
  const Spade = createLucideIcon("spade", __iconNode$4C);
  ...
  const Sparkle = createLucideIcon("sparkle", __iconNode$4B);
  ...
  const Sparkles = createLucideIcon("sparkles", __iconNode$4A);
  ...
  const Speech = createLucideIcon("speech", __iconNode$4x);
  ...
  const SprayCan = createLucideIcon("spray-can", __iconNode$4s);
  ...
  const Sprout = createLucideIcon("sprout", __iconNode$4r);
  ...
  const SquareArrowDownRight = createLucideIcon("square-arrow-down-right", __iconNode$4o);
  ...
  const SquareArrowDown = createLucideIcon("square-arrow-down", __iconNode$4n);
  ...
  const SquareArrowLeft = createLucideIcon("square-arrow-left", __iconNode$4m);
  ...
  const SquareArrowOutDownLeft = createLucideIcon("square-arrow-out-down-left", __iconNode$4l);
  ...
  const SquareArrowOutDownRight = createLucideIcon("square-arrow-out-down-right", __iconNode$4k);
  ...
  const SquareArrowOutUpLeft = createLucideIcon("square-arrow-out-up-left", __iconNode$4j);
  ...
  const SquareArrowOutUpRight = createLucideIcon("square-arrow-out-up-right", __iconNode$4i);
  ...
  const SquareArrowRight = createLucideIcon("square-arrow-right", __iconNode$4h);
  ...
  const SquareArrowUpLeft = createLucideIcon("square-arrow-up-left", __iconNode$4g);
  ...
  const SquareArrowUpRight = createLucideIcon("square-arrow-up-right", __iconNode$4f);
  ...
  const SquareArrowUp = createLucideIcon("square-arrow-up", __iconNode$4e);
  ...
  const SquareAsterisk = createLucideIcon("square-asterisk", __iconNode$4d);
  ...
  const SquareBottomDashedScissors = createLucideIcon("square-bottom-dashed-scissors", __iconNode$4c);
  ...
  const SquareCheck = createLucideIcon("square-check", __iconNode$49);

  const __iconNode$48 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "m16 10-4 4-4-4", key: "894hmk" }]
  ];
  const SquareChevronDown = createLucideIcon("square-chevron-down", __iconNode$48);

  const __iconNode$47 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "m14 16-4-4 4-4", key: "ojs7w8" }]
  ];
  const SquareChevronLeft = createLucideIcon("square-chevron-left", __iconNode$47);

  const __iconNode$46 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "m10 8 4 4-4 4", key: "1wy4r4" }]
  ];
  const SquareChevronRight = createLucideIcon("square-chevron-right", __iconNode$46);

  const __iconNode$45 = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "m8 14 4-4 4 4", key: "fy2ptz" }]
  ];
  const SquareChevronUp = createLucideIcon("square-chevron-up", __iconNode$45);
  ...
  const SquareCode = createLucideIcon("square-code", __iconNode$44);
  ...
  const SquareDashedBottomCode = createLucideIcon("square-dashed-bottom-code", __iconNode$43);
  ...
  const SquareDashedKanban = createLucideIcon("square-dashed-kanban", __iconNode$41);
  ...
  const SquareDashedMousePointer = createLucideIcon("square-dashed-mouse-pointer", __iconNode$40);
  ...
  const SquareLibrary = createLucideIcon("square-library", __iconNode$3V);

  const __iconNode$3U = [
    ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
    ["path", { d: "M8 16V8l4 4 4-4v8", key: "141u4e" }]
  ];
  const SquareM = createLucideIcon("square-m", __iconNode$3U);
  ...
  const SquareParkingOff = createLucideIcon("square-parking-off", __iconNode$3P);
  ...
  const SquarePen = createLucideIcon("square-pen", __iconNode$3O);
  ...
  const SquarePercent = createLucideIcon("square-percent", __iconNode$3N);
  ...
  const Squircle = createLucideIcon("squircle", __iconNode$3p);
  ...
  const Squirrel = createLucideIcon("squirrel", __iconNode$3n);
  ...
  const StretchHorizontal = createLucideIcon("stretch-horizontal", __iconNode$3d);

  const __iconNode$3c = [
    ["rect", { width: "6", height: "20", x: "4", y: "2", rx: "2", key: "19qu7m" }],
    ["rect", { width: "6", height: "20", x: "14", y: "2", rx: "2", key: "24v0nk" }]
  ];
  const StretchVertical = createLucideIcon("stretch-vertical", __iconNode$3c);
  ...
  const Sunrise = createLucideIcon("sunrise", __iconNode$33);
  ...
  const Superscript = createLucideIcon("superscript", __iconNode$32);
  ...
  const TableCellsMerge = createLucideIcon("table-cells-merge", __iconNode$2W);
  ...
  const TableCellsSplit = createLucideIcon("table-cells-split", __iconNode$2V);
  ...
  const WholeWord = createLucideIcon("whole-word", __iconNode$i);
